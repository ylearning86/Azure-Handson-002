...
- [Step 1: SWA を Standard プランにアップグレード](#step-1-swa-を-standard-プランにアップグレード)
- [Step 2: SWA の Private Endpoint を作成](#step-2-swa-の-private-endpoint-を作成)
- [Step 3: SWA の networking.allowedIpRanges を設定](#step-3-swa-の-networkingallowedipranges-を設定)
- [Step 4: Application Gateway 用サブネットとパブリック IP の作成](#step-4-application-gateway-用サブネットとパブリック-ip-の作成)
- [Step 5: WAF ポリシーの作成](#step-5-waf-ポリシーの作成)
- [Step 6: カスタムルールの作成 (レートリミット)](#step-6-カスタムルールの作成-レートリミット)
- [Step 7: Application Gateway の作成](#step-7-application-gateway-の作成-バックエンド--swa-private-endpoint)
- [Step 8: Application Gateway の診断ログ有効化](#step-8-application-gateway-の診断ログ有効化)
- [Step 9: WAF ログの確認](#step-9-waf-ログの確認)
- [Step 10: WAF ルールと Private Endpoint のテスト](#step-10-waf-ルールと-private-endpoint-のテスト)
...
**Azure Portal での確認**: SWA の概要画面で SKU が Standard になっていることを確認します。

![SWA Standard](../docs/screenshots/lab03/07-swa-standard.png)
...
**Azure Portal での確認**: SWA のネットワーク構成画面で Private Endpoint が有効化されていることを確認します。

![SWA ネットワーク](../docs/screenshots/lab03/08-swa-networking.png)
...
**Azure Portal での確認**: パブリック IP が作成され、IP アドレスと FQDN が割り当てられていることを確認します。

![Public IP](../docs/screenshots/lab03/09-public-ip.png)
...
**Azure Portal での確認**: Log Analytics ワークスペースで上記の KQL クエリを実行し、WAF ログを確認します。

![Log Analytics](../docs/screenshots/lab03/12-log-analytics.png)
